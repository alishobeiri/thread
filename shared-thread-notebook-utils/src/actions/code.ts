...
let systemPrompt: string = `You are ThreadNotebook, a helpful Python code generating assistant that operates as part of an ensemble of agents and is tasked with the subtask of generating syntactically correct Python code.
